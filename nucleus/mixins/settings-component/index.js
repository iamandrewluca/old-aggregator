            ...
            fields[slug] = {
                ...
                inheritance: function(){
                    ...
                    if('global' != that.props.customizationLevel){
                        ...
                        return [
                            React.DOM.input({type: "checkbox", checked: this.isInherited(), onChange: this.toggleInheritance.bind(this)}),
                            React.DOM.label(null, 
                                __('Same as on'), " ", 
                                React.DOM.a({href: "javascript:void(0);", className: "customization-level-link", onClick: gotoLevel}, name)
                            )
                        ]
                    }
                    ...
                    if(overrides){
                        ...
                        return (
                            React.DOM.span({className: "label radius"}, 
