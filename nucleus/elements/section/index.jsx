...
var Section = {
    ...
    render: function(){
        return (
            <section id="main" className="monstro-unboxed">
                <div className="main-container delimited solid">
                    {this.getCustomizationDropdown("top-middle")}
                    {this.getBreadcrumbsAndArchiveHeader()}
                    {/*<div className="full-width-row">*/}
                        <div className="row">
                            <div className="large-12 columns margin-bottom-60">
                                <div className="delimiter-type"/>{/* add .none and remove .margin-bottom-60 from parent */}
                            </div>
                        </div>
                    {/*</div>*/}
                    <div className="row">
